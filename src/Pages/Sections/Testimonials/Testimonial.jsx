       ...
       >
        ...
        transition={{duration:0.5 ,ease:"easeInOut"}}
         ...
         className='ring-2 ring-pink-50 rounded-b-2xl rounded-t-md md:rounded-2xl ring-offset-2 shadow-xl shadow-purple-300 w-[90vw] p-5 m-5 md:w-[25vw]'>
            <h3 className='text-[1rem] text-indigo-950 font-sans p-1'>
        ...
        transition={{duration:0.5,ease:"easeInOut"}}
         ...
         className='ring-2 ring-pink-50 rounded-b-2xl rounded-t-md md:rounded-2xl ring-offset-2 shadow-xl shadow-purple-300 w-[90vw] p-5 m-5 md:w-[25vw]'>
            <h3 className='text-[1rem] text-indigo-950 font-sans p-1'>My mentor was Manan Bhaiya, He is a very good guide. He use to talk in a friendly manner( never felt that I am talking to an elder).He use to motivate me even in bad situations( like getting low grades..).
After all, under his guidance I have seen good changes in my schedule and in myself ...</h3>
       ...
       <motion.div
        ...
        transition={{duration:0.5,ease:"easeInOut"}}
         ...
         className='ring-2 ring-pink-50 rounded-b-2xl rounded-t-md md:rounded-2xl ring-offset-2 shadow-xl shadow-purple-300 w-[90vw] p-5 m-5 md:w-[25vw]'>
            <h3 className='text-[1rem] text-indigo-950 font-sans p-1'>Leadlly seriously rocks! Their tips, support, and all that expert knowledge totally helped me level up. Thanks for being there every step of the way</h3>
            <p className=' text-[0.8rem] indent-[50%] font-sans p-1'>~ davinder singh</p>
        </motion.div></div>
       </div>
       </div>
       ...
       transition={{duration:0.5,ease:"easeInOut" }}>
        <div className='ring-2 ring-pink-50 rounded-b-2xl rounded-t-md md:rounded-2xl ring-offset-2 shadow-xl shadow-purple-300 w-[90vw] p-5 m-5 md:w-[25vw]'>
            <h3 className='text-[1rem] text-indigo-950 font-sans p-1 '>Mahip bhaiya is a very good mentor, the way in which he guided me and the tasks that he gave me are very good. I saw improvement in my learning skills. Also tracker and error book ne bhi meri bahut help ki. Overall leadlly helped me a lot in my journey....</h3>
            <p className=' text-[0.8rem] indent-[50%] font-sans p-1'>~ davinder singh</p>
        </div>
        <div className='ring-2 ring-pink-50 rounded-b-2xl rounded-t-md md:rounded-2xl ring-offset-2 shadow-xl shadow-purple-300 w-[90vw] p-5 m-5 md:w-[25vw]'>
            <h3 className='text-[1rem] text-indigo-950 font-sans p-1'>My mentor was Manan Bhaiya, He is a very good guide. He use to talk in a friendly manner( never felt that I am talking to an elder).He use to motivate me even in bad situations( like getting low grades..).
